...
const Hero = () => {
  ...
  <div className="flex space-x-4">
    <Tilt options={{ scale: 1.05 }}>
      <motion.a href='https://github.com/nishanth1104/Personal-website/blob/master/src/assets/Nishanth-Ayyalasomayajula-Resume.pdf' target='_blank' rel='noopener noreferrer' whileHover={{ scale: 1.1 }}>
