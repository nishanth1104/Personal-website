...
const Hero = () => {
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            <Typewriter
              options={{
              strings: ['LLM Engineer', 'Front-End Designer', 'Agentic AI Developer'],
              autoStart: true,
              loop: true,
              deleteSpeed: 50,
              delay: 75
  ...
  <div className="flex space-x-4">
    <Tilt options={{ scale: 1.05 }}>
      <motion.a href='https://github.com/nishanth1104/Personal-website/blob/master/src/assets/Nishanth_Ayyalasomayajula_Resume.pdf' target='_blank' rel='noopener noreferrer' whileHover={{ scale: 1.1 }}>
